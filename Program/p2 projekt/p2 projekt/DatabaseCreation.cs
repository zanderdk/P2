...
namespace p2_projekt
{
    public class DatabaseCreation
    {
        ...
        {                
                ...
                member.Permission = new Permission() { MemberInfo = EnumPermissionLevel.Write, Search = EnumPermissionLevel.Write, ChangePersonalInfo = EnumPermissionLevel.Write};
        ...
        public void CreateDataset(DALController uc, int wantedUsers)
        {
            ...
            TestMember1.Permission = new Permission() { ChangePersonalInfo = EnumPermissionLevel.None, MemberInfo = EnumPermissionLevel.None, Search = EnumPermissionLevel.None };
            Boat b1 = CreateBoat();
            ...
            TestMember2.Permission = new Permission() { ChangePersonalInfo = EnumPermissionLevel.Read, MemberInfo = EnumPermissionLevel.Read, Search = EnumPermissionLevel.Read };
            Boat b2 = CreateBoat();
            ...
            TestMember3.Permission = new Permission() { ChangePersonalInfo = EnumPermissionLevel.Write, MemberInfo = EnumPermissionLevel.None, Search = EnumPermissionLevel.None };
            b1 = CreateBoat();
            b1.BoatSpace = CreateBoatSpace();
