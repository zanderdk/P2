...
silent only
cd ~/Dropbox/AAU/Projekter/P2/Rapport
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 chapters/Teori/wpf.tex
badd +13 chapters/problemformulering.tex
badd +11 chapters/problemlosning.tex
badd +5 chapters/teori.tex
badd +0 master.tex
badd +0 chapters/design.tex
badd +0 chapters/test.tex
argglobal
silent! argdel *
edit chapters/test.tex
...
setlocal tabstop=4
setlocal tags=~/Dropbox/AAU/Projekter/P2/.git/plaintex.tags,~/Dropbox/AAU/Projekter/P2/.git/tags,./tags,tags
...
setlocal tabstop=4
setlocal tags=~/Dropbox/AAU/Projekter/P2/.git/tex.tags,~/Dropbox/AAU/Projekter/P2/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
wincmd w
argglobal
edit chapters/problemlosning.tex
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
