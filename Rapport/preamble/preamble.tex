...
\fancypagestyle{titlepagestyleeng}{
  \fancyfoot[OL, EL]{\textit{The content of this report is freely available, but publication may only be pursued according to agreement made with the authors.}}
  \fancyfoot[OR, ER]{}
  \fancyhead[OR,OL,ER,EL]{}
}
...
\hyphenation{båd-ejere båd-klub-ber}