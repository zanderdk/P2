...
Denne sektion dokumenter de grundlæggende modeller, som programmet er bygget op efter samt beskriver det samlede klassehierarki som vist på \cref{fig:UML}.
