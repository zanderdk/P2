...
\subsection{Gæster}
    ...
    \item{\bf{Gæst er ankommet til havnen, og vil leje en plads}}
      \begin{enumerate}
        \item Gæsten registrere sig selv i systemet.
        \item Gæsten benytter chipkortet til at logge ind.
        \item Gæsten finder oversigten over havnen og finder en ledig plads
        \item Gæsten vælger den ledige plads og booker den
...
\subsection{Andre}
	...
	\item{\bf{Kasser eller havnefogede vil tilføje ny båd til et medlem}}
	  \begin{enumerate}
		...
		\item Systemet melder tilbage at båden er gemt
	   \end{enumerate}
