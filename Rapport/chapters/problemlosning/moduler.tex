...
På \cref{fig:mod} ses en oversigt over implementerede moduler og deres relationer. Diagrammet viser hvordan visuelt fokus flyttes rundt. Der bliver altså skifter hvad bruger ser på brugergrænsefladen. Derudover bliver der vist hvordan data bliver flyttet rundt via metodekald. Modulerne er inddelt i primære funktion og adgangskrævende funktioner.
