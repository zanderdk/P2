...
\item \label{itm:events} \textbf{Krav 1}
Under kravet omkring udlejning og betaling, ligger fokuset på at få funktionalitet af udlejningen til at virke. Betalingssystemet og integrationen med Vestre Baadelaugs nuværnende betalingssytem bliver nedprioriteret i forhold med funktionalitet af systemet, siden det vil være en stor opgave ressourcemessigt.

\item \label{itm:events} \textbf{Krav 5}
Kravet omkring fejlmelding til havnefogeden er ikke essentielt for programmets funktionalitet, og er derfor prioriteret lavt i forhold til systemets kernefunktioner.

\item \label{itm:events} \textbf{Krav 6}
Dette et omspændende krav om understøttelsen af gæster til systemet. Det medfører at kravet vil blive opfyldt gradvist i projektet siden underkravene deler prioritets niveauer med andre krav og funktionalitet.

\item \label{itm:events} \textbf{Krav 9}
Eventkalender tænkes som et socialt middel der kan bruges af VB til at prmovere events og LOBOP, men siden det ikke er nødvendigt for projektets funktionalitet, vil det være nederst på prioritets listen.
\end{enumerate}
