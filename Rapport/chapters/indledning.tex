...
Vi startede med projektforslaget der talte om udlejning af både. Men vi fandt hurtigt ud af at, der ikke var mange klubber der leger både ud. I stedet for valgete vi at focusere på administrationen i bådklubberne. Der kan gå meget tid med administrationsarbejde, hvilket kan bruges på andre opgaver. Derfor vil vores problem analyse tage udgangspunkt i dette initierende problem:
...
For at undersøge dette vil vi lave interviewes med flere repræsentanter fra en bådklub. Laudon og Laudon modellen benyttes til at sætte et IT system i kontekst. Vi vil komme frem til en problemformulering og lave et program der løser det formulerede problem.
