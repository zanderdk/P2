...
I forbindelse med Vestre Baadelaugs ønske om et socialt liv på havnen, som beskrevet i \cref{social}, kunne der inkluderes funktioner som forbedrer de sociale muligheder. Dette kunne eventuelt være en form for event-håndtering, såsom en kalender eller en opslagsskærm i klubhuset. Medlemmer kunne så opslå initiativer til spontane arrangementer, eksempelvis fælles aftensmad hvis vejret viser sig at være godt. Måske kunne systemet, på aftener hvor der er detekteret mange medlemmer i havnen, selv lave opslag til arrangementsforslag.
