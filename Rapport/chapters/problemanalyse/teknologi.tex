...
\begin{figure}[h]
  ...
  \end{minipage}
    \caption{Betalingssyste, kortsystem og elsystem set på Vestre Baadehavn}\label{fig:vb_systemer}
\end{figure}
...
\sinote{måske skal foreninglet afsnit ikke være under teknologi, da det ikke hører under havnefogens arbejde}
