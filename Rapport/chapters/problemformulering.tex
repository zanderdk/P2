...
De nuværende krav er primære krav som er nøvendige for at kunne implementere et software program der løser problemstillingen. Men kravne er ikke tilstrækkelige nok til at kunne opfylde alle interessenternes behov. Ud fra dette er en yderligere kravspecifikation er opstillet. Kravne herunder er lavere privoitere i fohold til de tideligere nævnte krav, og vil blive implementeret såfremt alle tideligere nævnte krav er opfyldt.

\begin{enumerate}[resume]
	\item \label{itm:gui} \textbf{Systemet skal være brugervenligt.}	
		programmet skal have en grafisk brugergrænseflade som vil blive betegnet som GUI. GUI'en har til formål at gøre software programmet mere bruger venligt, og skabe et mere overskueligt overblik over havne for havnefogeden samt gæster og medlemmer. Behovet for dette krav er underbygget af \cref{aspekter} hvor det er beskrevet at havnefogeden på visse tidspunkter har overbliks problemer.
