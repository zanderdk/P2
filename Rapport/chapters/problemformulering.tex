...
\sinote{Inddrag evt. Martin i den hvide trøje fra status, omkring en kilde}

\sinote{Problemet skal indskærpes. Specificer hvilken del vi vil arbejde med, skriv kun om havn. Vi skal vise at vi har taget dette valg}
\begin{displayquote}
\textbf{\textit{Hvordan kan man modellere en bådklubs administrative ansvarsområder herunder både, bådpladser, medlemmer og gæster, samt implementere et software program der automatiserer denne administration}}
\end{displayquote}
...
\sinote{Lav kravspecifikation som decimaltal, og mere punktform som beskrivelse}
...
\sinote{Eventkalender krav}
  ...
  \subsubsection{Systemet skal kunne håndtere udlejning af vandlejepladser ved at integrere med Vestre Baadelaugs nuværende system.}
  ...
  Ved at integrere sikres et funktionelt system med henblik på besparelse og tilvændingstiden for det nye system minimeres.
  ...
  \subsubsection{Systemet skal gemme hvilke pladser der er ejet, hvilken båd der er på pladsen, og af hvilken ejer.}
  ...
  \subsubsection{Systemet skal kunne søge igennem den lagrede data efter en række søgekriterier.}
