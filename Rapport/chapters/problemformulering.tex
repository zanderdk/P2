...
Under kravet omkring udlejning og betaling, ligger fokus på at få funktionalitet af udlejningen til at virke. Betalingssystemet og integrationen med Vestre Baadelaugs nuværende betalingssystem bliver nedprioriteret i forhold til funktionalitet af systemet, siden det vil være en stor opgave ressourcemæssigt.
...
Eventkalender tænkes som et socialt middel der kan bruges af VB til at promovere events og LOBOP, men siden det ikke er nødvendigt for projektets funktionalitet, vil det være nederst på prioritets listen.
\end{enumerate}
